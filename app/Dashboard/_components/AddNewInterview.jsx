...
function AddNewInterview() {
  ...
  const onSubmit = async (e) => {
    ...
    const numQuestions = process.env.NEXT_PUBLIC_INTERVIEW_QUESTION || 5;

    const InputPromt = `Generate ${numQuestions} interview questions and answers in JSON format based on the following details:
...
Do not include any markdown, text, or extra symbols — only pure JSON.`;
